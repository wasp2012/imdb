...
abstract class $MoviesStateCopyWith<T, $Res> {
  factory $MoviesStateCopyWith(
      ...
      _$MoviesStateCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$MoviesStateCopyWithImpl<T, $Res>
    implements $MoviesStateCopyWith<T, $Res> {
  _$MoviesStateCopyWithImpl(this._value, this._then);

  final MoviesState<T> _value;
  // ignore: unused_field
  final $Res Function(MoviesState<T>) _then;
}
...
/// @nodoc
class __$$IdleCopyWithImpl<T, $Res> extends _$MoviesStateCopyWithImpl<T, $Res>
...
abstract class Idle<T> implements MoviesState<T> {
...
class __$$LoadingCopyWithImpl<T, $Res>
    extends _$MoviesStateCopyWithImpl<T, $Res>
...
abstract class Loading<T> implements MoviesState<T> {
...
class _$Success<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'MoviesState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements MoviesState<T> {
...
/// @nodoc
class __$$ErrorCopyWithImpl<T, $Res> extends _$MoviesStateCopyWithImpl<T, $Res>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'MoviesState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements MoviesState<T> {
