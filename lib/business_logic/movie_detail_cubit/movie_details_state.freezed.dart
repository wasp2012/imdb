...
abstract class $MovieDetailsStateCopyWith<T, $Res> {
  factory $MovieDetailsStateCopyWith(MovieDetailsState<T> value,
      ...
      _$MovieDetailsStateCopyWithImpl<T, $Res>;
}
...
class _$MovieDetailsStateCopyWithImpl<T, $Res>
  ...
  final MovieDetailsState<T> _value;
  // ignore: unused_field
  final $Res Function(MovieDetailsState<T>) _then;
}
...
class _$Idle<T> implements Idle<T> {
  ...
  @override
  String toString() {
    return 'MovieDetailsState<$T>.idle()';
  }
...
abstract class Idle<T> implements MovieDetailsState<T> {
...
abstract class Loading<T> implements MovieDetailsState<T> {
...
abstract class Success<T> implements MovieDetailsState<T> {
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'MovieDetailsState<$T>.error(networkExceptions: $networkExceptions)';
  }
